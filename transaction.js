...
async function main() {
     ...
     */
    // const uri = "mongodb://localhost:27017/test?retryWrites=true&w=majority&replicaSet=rs0";
    const uri = "mongodb://mongo-rs0:27017/test?replicaSet=rs0";
    ...
    try {
        ...
        if (err.reason) {
            console.log(`reason: ${JSON.stringify(err.reason)}`);
        }
    } finally {
